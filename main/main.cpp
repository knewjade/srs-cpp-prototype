...
void test1() {
    ...
    const auto board = data<Data>::AlignedBoard{load_board<Data>("")};
    std::cout << to_string(board.columns, height) << std::endl;

    // T
    {
        constexpr auto shape = Shape::T;
        const auto result = s::searcher<Data, shape>::search(board, Orientation::North, 4, 20);
        test(board.columns, height, result, shape, 34);
    }
    // I
    {
    ...
    // O
    {
        ...
        const auto result = s::searcher<Data, shape>::search(board, Orientation::North, 4, 20);
        test(board.columns, height, result, shape, 9);
    }
}

template<typename Data>
data<Data>::AlignedBoard lemontea_tspin_board() {
...
void test2() {
    ...
    // T
    {
        constexpr auto shape = Shape::T;
        const auto result = s::searcher<Data, shape>::search(board, Orientation::North, 4, 20);
        test(board.columns, height, result, shape, 37);
    }
    // I
    {
        constexpr auto shape = Shape::I;
    ...
    // J
    {
        constexpr auto shape = Shape::J;
        const auto result = s::searcher<Data, shape>::search(board, Orientation::North, 4, 20);
        test(board.columns, height, result, shape, 35);
    }
    // S
    {
        constexpr auto shape = Shape::S;
...
void test3() {
    ...
    // I
    {
        constexpr auto shape = Shape::I;
        const auto result = s::searcher<Data, shape>::search(board, Orientation::North, 4, 20);
        test(board.columns, height, result, shape, 93);
    }
    // J
    {
        constexpr auto shape = Shape::J;
    ...
    // Z
    {
        constexpr auto shape = Shape::Z;
        const auto result = s::searcher<Data, shape>::search(board, Orientation::North, 4, 20);
        test(board.columns, height, result, shape, 129);
    }
    // O
    {
        constexpr auto shape = Shape::O;
...
int main() {
    ...
    // empty
    {
        ...
        using T = uint8_t;
        const auto board_bytes = data<T>::AlignedBoard{};
    ...
    // lemontea tspin
    {
        ...
        using T = uint16_t;
        const auto board_bytes = lemontea_tspin_board<T>();
